...
const connectDB = async () => {
    try {
        ...
        console.log("MongoDB connected for seeding content...");
    } catch (error) {
...
const furnitureImages = {
    sofas: [
        ...
        "https://images.unsplash.com/photo-1617806118233-18e1db208fa0?q=80&w=1931&auto=format&fit=crop",
        "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?q=80&w=2070&auto=format&fit=crop"
    ],
    beds: [
        "https://images.unsplash.com/photo-1505693415918-91e544a1c1d0?q=80&w=2070&auto=format&fit=crop",
        "https://images.unsplash.com/photo-1540518614846-7eded433c457?q=80&w=2070&auto=format&fit=crop",
        "https://plus.unsplash.com/premium_photo-1661962771640-426ce94f16c6?q=80&w=3131&auto=format&fit=crop"
    ],
    dining: [
        "https://images.unsplash.com/photo-1617806118233-18e1db247200?q=80&w=1931&auto=format&fit=crop",
        "https://images.unsplash.com/photo-1595515106969-1ce29566ff1c?q=80&w=1974&auto=format&fit=crop"
    ],
    chairs: [
        "https://images.unsplash.com/photo-1592078615290-033ee584e267?q=80&w=1080",
    ...
    decor: [
        ...
        "https://images.unsplash.com/photo-1612196808214-b7e239e5f6b7?q=80&w=1974&auto=format&fit=crop",
        "https://images.unsplash.com/photo-1582201943021-e8e644a99184?q=80&w=1974&auto=format&fit=crop"
    ],
    lighting: [
        "https://images.unsplash.com/photo-1513506003011-3b03c94787d5?q=80&w=1974&auto=format&fit=crop",
        "https://images.unsplash.com/photo-1507473888900-52e1adad8d69?q=80&w=1974&auto=format&fit=crop"
    ]
};
...
const seedContent = async () => {
    try {
        const targetUser = await User.findOne({ role: 'customer' }).sort({ createdAt: -1 });
        if (!targetUser) {
            console.error("Error: No customer user found.");
            process.exit(1);
        }
        ...
        console.log("Creating high-fidelity products...");
        const productsData = [
            // Living Room
            {
        ...
        console.log("Creating historical orders for target user...");
        const orders = [];
        const numOrders = 20;
        const now = new Date();
        ...
        for (let i = 0; i < numOrders; i++) {
            ...
            orders.push({
                ...
                guestInfo: {
                    ...
                    phone: targetUser.phone || "9800000000"
                },
                items: orderItems,
                shippingAddress: {
        ...
        console.log("Content seeded successfully with REAL products!");
        process.exit(0);
    } catch (error) {
